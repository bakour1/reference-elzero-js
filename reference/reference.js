...
//  number ▶▶
{
  ...
  // number methods
  {
    ...
    console.log( 10 * 10 _000 ); // 100000
    console.log( 100000.00 ); // 100000
    console.log( 50 _000 + 50 _000 ); // 100000
...
// string methods ▶▶
{
  ...
  console.log( text.replace( /[ain]/g, e => ( {
    'a': '1',
    'i': '2',
    'n': '3'
  } )[ e ] ) ); // The r123 23 SPAIN st1ys m123ly 23 the pl123
...
// Array ▶▶
{
  ...
  */
  ...
  // array.from()
  {
    ...
    const rangeArray = ( start, stop, step ) => Array.from( {
...
// replace ▶▶
{
  ...
  let replaceStr = str => str.replace( /[015]/g, e => ( {
    '0': 'O',
    '1': 'I',
    '5': 'S'
  } )[ e ] );
  ...
  // method 1
  let correctPolishLetters = str => str.replace( /[ąćęłńóśźż]/g, e => ( {
    'ą': 'a',
    'ć': 'c',
    'ę': 'e',
    'ł': 'l',
...
//  AND , OR , XOR
{
  ...
  function logicalCalc3 ( array, op ) {
    switch ( op ) {
      ...
      case 'XOR':
        return Boolean( array.filter( Boolean ).length & 1 );
    }
  }
...
// object
{
  ...
  // Object.defineProperty()
  {
    ...
    // Change a property
    Object.defineProperty( objTest, "language", {
      value: "NO"
    } );
    ...
    */
    ...
    // Adding a Property
    Object.defineProperty( objTest, "year", {
      value: "2008"
    } );
  ...
  // E5 Object Methods
  {
    ...
    } ) ); // {id: 30, name: 'sami', property1: 42, property2: 30}
...
// Destructuring
{
  ...
  const {
    US: u_price,
    JAP: j_price
  } = game.releases[ "Ark Of Napishtim" ];
...
// Set Data Type
{
  //  Set Data Type And Methods
  {
    ...
    myUniqueData.forEach( ( value, key, set ) => console.log( value, key, set ) );
    /* 1 1 Set(3) {1, 2, 3}
                                                                                         2 2 Set(3) {1, 2, 3}
                                                                                         3 3 Set(3) {1, 2, 3}
                                                                                         6 6 Set(4) {1, 2, 3, 6}*/
  ...
  */
    ...
    console.log( myNewMap.forEach( ( value, key ) => console.log( key, value ) ) );
    /*main.js:44 true 'Boolean'
